-- Script corrigé pour adapter les tables existantes dans Supabase Cloud
-- 27/12/2024 - Correction après vérification de la structure
...
-- Étape 2 : Insérer les sources LBA et FT
