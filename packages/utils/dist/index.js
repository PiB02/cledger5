...
__export(index_exports, {
  ...
  estimateBatchDuration: () => estimateBatchDuration,
  estimateOpenAICost: () => estimateOpenAICost,
  formatCost: () => formatCost,
  formatDuration: () => formatDuration,
  generateOfferFingerprint: () => generateOfferFingerprint,
  hashEmbeddingText: () => hashEmbeddingText,
  normSkill: () => normSkill,
  normalizeEmail: () => normalizeEmail,
  normalizeNafCode: () => normalizeNafCode,
  normalizePhoneNumber: () => normalizePhoneNumber,
  normalizePostalCode: () => normalizePostalCode,
  normalizeRomeCode: () => normalizeRomeCode,
  normalizeSiret: () => normalizeSiret,
